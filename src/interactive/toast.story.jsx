...
class ToasterContainer extends React.PureComponent {
	...
	render() {
		...
		return (
			<div>
				<Toaster toasts={this.state.addedToasts} />
...
storiesOf('Toast', module)
	...
	.addParameters({ info: { propTables: [Toaster, Toast], propTablesExclude: [ToasterContainer] } })
	...
	.add('action on dismiss', () => (
		<Toaster
			toasts={[
				<Toast autodismiss={false} onDismiss={() => alert("you're dismissed!")}>
					Alert on dismiss
				</Toast>,
			]}
		/>
	...
	.add('multiple', () => (
		<Toaster
			toasts={[
				<Toast>Your toast is ready</Toast>,
				<Toast>Read this important message</Toast>,
				<Toast>Skim this nice-to-know message</Toast>,
			]}
		/>
	))
	.add('withAction', () => (
