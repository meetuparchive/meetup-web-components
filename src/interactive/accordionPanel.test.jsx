...
describe('AccordionPanel', function() {
	...
	beforeEach(() => {
        ...
        getHeightMock = jest.spyOn(AccordionPanel.prototype, 'getHeight').mockImplementation(() => {});
    ...
    describe('right aligned panel icon', () => {
        ...
        it('exists and renders icon left', function(){
    ...
    describe('panel with toggle switch', () => {
        ...
        it('shoudl call handleToggle when clicking toggle switch', function() {
