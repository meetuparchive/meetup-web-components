 ...
 */
export const getUpdatedMediaState = mediaQueries =>
	mediaQueries.reduce((state, mq, i) => {
...
const withMatchMedia = WrappedComponent => {
	...
	WithMatchMedia.WrappedComponent = WrappedComponent;
	WithMatchMedia.displayName = `WithMatchMedia(${wrappedComponentName})`;
