...
storiesOf('Forms/Button', module)
	...
	.add('Default - with hover shadow', () => (
		<Button onClick={action('clicked')} hasHoverShadow>
			Button Label
		</Button>
	))
	...
	.add('Neutral', () => (
		<Button onClick={action('clicked')} neutral>
			Button Label
		</Button>
	))
	.add('Neutral - with hover shadow', () => (
		<Button onClick={action('clicked')} neutral hasHoverShadow>
			Button Label
		</Button>
	))
	...
	.add('Primary - with hover shadow', () => (
		<Button onClick={action('clicked')} primary hasHoverShadow>
			Button Label
		</Button>
	))
	...
	.add('Bordered - disabled', () => (
		...
		>
			<Button onClick={action('clicked')} bordered disabled>
				Button Label
			</Button>
		</div>
	))
	...
	.add('Reset', () => (
		<Button onClick={action('clicked')} reset>
			Button Label
		</Button>
	))
	.add('Reset - inverted', () => (
	...
	.add('Reset - Disabled', () => (
		<Button onClick={action('clicked')} reset disabled>
			Button Label
		</Button>
	))
	.add('Full Width', () => (
